...
```{r generate_test_set, fig.height=9}
set.seed(1234)
# real curves
...
```{r evaluate_test_set}
test_evaluation_df = data.frame(Method = "GAN embedding + M-distance", Threshold = "5th quantile", ACC = 0.980, TPR = 0.960, FPR = 0.960, AUC = 1.0)
