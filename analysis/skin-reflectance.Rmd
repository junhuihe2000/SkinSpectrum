...
generate_fake_1 <- function(n = 100) {
  mean = seq(5, 70, length.out = length(wavelength))
  t(mean + matrix(rnorm(n, 0, 1), nrow = length(wavelength), ncol = n))
}
fake_1 = generate_fake_1(100)
colnames(fake_1) = wavelength
fake_df_1 = as.data.frame(fake_1)
```
